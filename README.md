...
|----------|--------|-------|
| **museum-experiences.com (WordPress)** | Retiring | Replaced by this static GitHub Pages site at the same domain |
...
- **This repo** is the replacement for the old WordPress site at **museum-experiences.com** (the domain you own).
- `CNAME` points GitHub Pages at `museum-experiences.com`.
- DNS for `museum-experiences.com` must point to GitHub Pages — until then, visitors still see WordPress on SiteGround.

### DNS cutover checklist

1. **GitHub** → Settings → Pages → confirm custom domain `museum-experiences.com` → enable **Enforce HTTPS**
2. **DNS** at registrar for **museum-experiences.com**:
...
3. Wait for propagation; verify the static site loads at `https://museum-experiences.com/`
4. **Retire WordPress** — keep 301 redirects from old WordPress URLs for 6–12 months minimum
...
- [ ] **DNS cutover** — point museum-experiences.com to GitHub Pages (replace SiteGround WordPress)
